...
const Header = () => (
  <header className="z-10 relative shadow">
    <div className="container mx-auto 2xl px-4 lg:px-0.5 py-8 lg:py-6 pb-7 flex flex-row flex-1 justify-between">
      <h1 className="text-sm lg:text-2xl font-extrabold">
        Where in the world?
      </h1>
      <button className="text-xs lg:text-base font-semibold tracking-wide">
        <img
          src={MoonIcon}
